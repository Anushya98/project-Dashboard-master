                       ...
                       <div class="card-body">
                           <div class="d-flex align-items-center">
                               <div class="avatar-sm flex-shrink-0 svg-color-1" >
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="white" class="bi bi-person-plus" viewBox="0 0 16 16" style={{marginLeft:"12px", marginTop:"10px"}}>
                               ...
                               <div class="flex-grow-1 ms-3" style={{color:"white",textShadow:"2px 2px 4px #000000"}}>
                                   <p class="text-uppercase fw-bold mb-3 ">New Users</p>
                   ...
                   <div className="Cardbox1">
                       <div class="card-body">
                           <div class="d-flex align-items-center">
                               ...
                               <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="white"  class="bi bi-person" viewBox="0 0 15 15"  style={{marginLeft:"12px", marginTop:"10px"}}>
                               ...
                               <div class="flex-grow-1 ms-3" style={{color:"white",textShadow:"2px 2px 4px #000000"}}>
                                   <p class="text-uppercase fw-bold mb-3">Controllers</p>
                                   <div class="d-flex align-items-center mb-3">
                                       <h4 class="fs-2 flex-grow-1 mb-0">
                                       <i class="ri-arrow-down-s-line fs-13 align-middle me-1"></i>
                   ...
                   <div className="Cardbox2">
                       <div class="card-body">
                           <div class="d-flex align-items-center">
                               ...
                               <div class="flex-grow-1 ms-3" style={{color:"white", textShadow:"2px 2px 4px #000000"}}>
                                   <p class="text-uppercase fw-bold mb-3">Designers</p>
                                   <div class="d-flex align-items-center mb-3">
                                       <h4 class="fs-2 flex-grow-1 mb-0">
                                       <i class="ri-arrow-down-s-line fs-13 align-middle me-1"></i>
                                       <CountUp start={ 0 } end={ userCount } duration={ 2.75 } separator="," />
