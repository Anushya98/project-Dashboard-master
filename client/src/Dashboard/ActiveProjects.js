                       ...
                       <div class="card-body" style={{ padding: "15px" }}>
                           <div class="d-flex align-items-center">
                               <div class="avatar-sm flex-shrink-0 svg-color-1">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="white" class="bi bi-file-earmark-check" viewBox="0 0 16 16"  style={{marginLeft:"12px", marginTop:"10px"}}>
                               ...
                               <div class="flex-grow-1 ms-3" style={{color:"white",textShadow:"2px 2px 4px #000000"}}>
                                   <p class="text-uppercase fw-bold mb-3">Total Projects Completed</p>
                       ...
                       <div class="card-body" style={{ padding: "15px" }}>
                           <div class="d-flex align-items-center">
                               <div class="avatar-sm flex-shrink-0 svg-color-2">
                                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="white" class="bi bi-arrow-repeat" viewBox="0 0 16 16"  style={{marginLeft:"12px", marginTop:"10px"}}>
                                      <path d="M11.534 7h3.932a.25.25 0 0 1 .192.41l-1.966 2.36a.25.25 0 0 1-.384 0l-1.966-2.36a.25.25 0 0 1 .192-.41zm-11 2h3.932a.25.25 0 0 0 .192-.41L2.692 6.23a.25.25 0 0 0-.384 0L.342 8.59A.25.25 0 0 0 .534 9z"/>
                                      <path fill-rule="evenodd" d="M8 3c-1.552 0-2.94.707-3.857 1.818a.5.5 0 1 1-.771-.636A6.002 6.002 0 0 1 13.917 7H12.9A5.002 5.002 0 0 0 8 3zM3.1 9a5.002 5.002 0 0 0 8.757 2.182.5.5 0 1 1 .771.636A6.002 6.002 0 0 1 2.083 9H3.1z"/>
                                  </svg>
                               </div>
                               <div class="flex-grow-1 ms-3" style={{color:"white",textShadow:"2px 2px 4px #000000"}}>
                                   <p class="text-uppercase fw-bold mb-3">Total Ongoing Projects</p>
                                   <div class="d-flex align-items-center mb-3">
                                       <h4 class="fs-2 flex-grow-1 mb-0">
                                       <i class="ri-arrow-down-s-line fs-13 align-middle me-1"></i>
                    ...
                    <div className="Cardbox2">
                       <div class="card-body" style={{ padding: "15px" }}>
                           <div class="d-flex align-items-center">
                               ...
                               <div class="flex-grow-1 ms-3" style={{color:"white", textShadow:"2px 2px 4px #000000"}}>
                                   <p class="text-uppercase fw-bold mb-3">Total Overdue Projects</p>
                                   <div class="d-flex align-items-center mb-3">
                                       <h4 class="fs-2 flex-grow-1 mb-0">
                                       <i class="ri-arrow-down-s-line fs-13 align-middle me-1"></i>
